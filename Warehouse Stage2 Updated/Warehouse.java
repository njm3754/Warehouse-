...
public class Warehouse implements Serializable{
  ...
  public static Warehouse instance() {
   ...
   public Product addProduct(String ID, String name, String description, float price) {
  ...
  private void readObject(java.io.ObjectInputStream input) {
    ...
    public Invoice addOrder(Order order){
        ...
        Invoice invoice = client.addOrder(order);
        return invoice;
    }
    ...
    public float makePayment(String clientID, float paymentAmount){     
       Client c1 = clientList.searchClient(clientID);
        return c1.makePayment(paymentAmount);
    }
